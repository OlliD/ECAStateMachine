#############################################################################
# Makefile for building: eventtransitions.app/Contents/MacOS/eventtransitions
# Generated by qmake (2.01a) (Qt 4.6.3) on: Mo. Jul 19 14:47:17 2010
# Project:  eventtransitions.pro
# Template: app
# Command: /opt/local/bin/qmake -macx -o Makefile.xcodeproj/project.pbxproj eventtransitions.pro
#############################################################################
...
YACC      = yacc
YACCFLAGS = -d
DEFINES       = -DQT_STATEMACHINE_SOLUTION -DQT_NO_ANIMATION -DQT_GUI_LIB -DQT_CORE_LIB -DQT_SHARED
INCPATH       = -I/usr/local/Qt4.6/mkspecs/macx-xcode -I. -I/Library/Frameworks/QtCore.framework/Versions/4/Headers -I/usr/include/QtCore -I/Library/Frameworks/QtGui.framework/Versions/4/Headers -I/usr/include/QtGui -I/usr/include -I. -I../../src -I. -I/usr/local/include -I/System/Library/Frameworks/CarbonCore.framework/Headers -F/Library/Frameworks
DEL_FILE  = rm -f
MOVE      = mv -f
