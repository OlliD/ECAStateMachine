...
Makefile.xcodeproj/project.pbxproj: composition.pro  /usr/local/Qt4.6/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.6/mkspecs/common/unix.conf \
	...
	$(QMAKE) -macx -o Makefile.xcodeproj/project.pbxproj composition.pro
