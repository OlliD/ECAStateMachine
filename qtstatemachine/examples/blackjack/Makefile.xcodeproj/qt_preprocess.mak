...
# Template: app
# Command: /opt/local/bin/qmake -macx -o Makefile.xcodeproj/project.pbxproj blackjack.pro
#############################################################################
...
INCPATH       = -I/usr/local/Qt4.6/mkspecs/macx-xcode -I. -I/Library/Frameworks/QtCore.framework/Versions/4/Headers -I/usr/include/QtCore -I/Library/Frameworks/QtGui.framework/Versions/4/Headers -I/usr/include/QtGui -I/Library/Frameworks/QtScript.framework/Versions/4/Headers -I/usr/include/QtScript -I/usr/include -I. -I../../src -I. -I. -I/usr/local/include -I/System/Library/Frameworks/CarbonCore.framework/Headers -F/Library/Frameworks
DEL_FILE  = rm -f
MOVE      = mv -f
...
compilers: ./moc_qstatemachine.cpp ./moc_qstateaction.cpp ./moc_qabstractstate.cpp\
	 ...
	 ./moc_qscriptedstatemachine.cpp ./moc_qssmguiinvokers_p.cpp ./qrc_bj.cpp ./qscriptedstatemachine.moc ./ui_blackjack.h
...
compiler_rcc_make_all: qrc_bj.cpp
compiler_rcc_clean:
	-$(DEL_FILE) qrc_bj.cpp
qrc_bj.cpp: bj.qrc
	/Developer/Tools/Qt/rcc -name bj bj.qrc -o qrc_bj.cpp
...
compiler_uic_make_all: ui_blackjack.h
compiler_uic_clean:
	-$(DEL_FILE) ui_blackjack.h
ui_blackjack.h: blackjack.ui
	/Developer/Tools/Qt/uic blackjack.ui -o ui_blackjack.h
